...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vegafusion-jupyter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15634&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vegafusion-jupyter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vegafusion-jupyter` can be installed with:

```
conda install vegafusion-jupyter
```

It is possible to list all of the versions of `vegafusion-jupyter` available on your platform with:
